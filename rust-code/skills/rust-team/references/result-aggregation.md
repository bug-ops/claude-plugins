...
1. **Handoff files** — each agent creates a `.md` handoff file via `rust-agent-handoff` skill in `.local/handoff/`. Teamlead receives inline frontmatter + paths from agents in their completion messages.
